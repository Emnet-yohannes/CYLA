            ...
            >
              ...
              >
                <path
                  ...
                  fill="currentColor"
                />
                <path d="M4 20V18H6V20H4Z" fill="currentColor" />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
              ...
              <form className="flex flex-col md:flex-row w-full">
                <div className="space-y-2">
                  <div className="relative inline-block md:min-w-[300px] md:w-fit w-full">
                    ...
                    <input
                      autoComplete="off"
                      className="flex h-10 rounded-md border dark:border-brand/70 border-brand/80 px-3 py-2 pl-10 text-sm ring-offset-background dark:bg-black bg-white w-full placeholder:text-black/60 dark:placeholder:text-brand/50 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-2"
